  ...
  return (
    <Stack sx={styles.root} direction="row">
      <Stack
        ...
        animate="rest"
      >
        <Stack component={'button'} sx={{ ...styles.button, backgroundColor: "#ff5f57" }} onClick={() => dispatch(closeWindow('Terminal'))}>
          <MotionDiv
            variants={{
        ...
        <Stack component={'button'} sx={{ ...styles.button, backgroundColor: "#febc2e" }} onClick={()=>dispatch(minimizedWindow('Terminal'))}>
          <MotionDiv
            variants={{
