  ...
  return (
    <Stack sx={styles.root} direction="row">
      <Stack
        ...
        animate="rest"
      >
        <Stack component={'button'} sx={{ ...styles.button, backgroundColor: "#ff5f57" }} onClick={() => dispatch(closeWindow('Videos'))}>
          <MotionDiv
            variants={{
        ...
        <Stack component={'button'} sx={{ ...styles.button, backgroundColor: "#febc2e" }} onClick={()=>dispatch(minimizedWindow('Videos'))}>
          <MotionDiv
            variants={{
      ...
      <Typography sx={{color:"white"}}>Videos</Typography>
      <Stack sx={{ width: 100 }} />
    </Stack>
  );
};
